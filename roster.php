...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="#">ROSTER <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-4">
        <img src="images/hm_photo_filtre.jpg" class="heqd" width="100%">
    </div>
    <div class="container mt-4">
        <div class="row">
        <?php
        foreach ($members as $m) {
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                <div class="card card-image">
                    <div class="card-child" style="background-image: url(' . $m[7] . ');"></div>
                    <div class="card-header">
                        <h5 class="float-left" style="width: 80%">' . $m[0] . ' ';
                        if ($m[1] != 0) {
                            echo '<img width="15px" height="15px" src="';
                            if ($m[1] === 2) {
                                echo 'images/icon_SVG/gm.svg">';
                            } elseif ($m[1] === 1) {
                                echo 'images/icon_SVG/officier.svg">';
                            }
                        }
                        echo
                        '</h5>
                        <img class="float-right" width="23px" height="23px" src="';
                        if ($m[2] === 0) {
                            echo 'images/class_icon/tank.png';
                        } elseif ($m[2] === 1) {
                            echo 'images/class_icon/healer.png';
                        } elseif ($m[2] === 2) {
                            echo 'images/class_icon/dps.png';
                        }
                        echo 
                        '">
                    </div>
                    <div class="card-body">
                        <p class="class" style="color: ' . $m[3] . ';">' . $m[4] . '</p>
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <a href="' . $m[5] . '" class="btn btn-dark mr-2" target="_blank">
                                <img width="30px" height="30px" src="images/icon_SVG/armorywow.svg">
                            </a>
